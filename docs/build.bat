...
set JAVAFX_HOME="C:\Program Files (x86)\javafx-sdk-16"
...
javadoc --module-path %JAVAFX_HOME%\lib --add-modules=%JAVAFX_MODULES% -sourcepath %PRAC_SRC% -classpath %PRAC_BIN%;%PRAC_LIB% -use -version -author -d %PRAC_DOCS%\JavaDoc %PRAC_SRC%\*.java
IF /I "%ERRORLEVEL%" NEQ "0" (
